...
namespace DanielLochner.Assets.SimpleScrollSnap1
{
    [AddComponentMenu("UI/Simple Scroll-Snap")]
    [RequireComponent(typeof(ScrollRect))]
    public class SimpleScrollSnap1 : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler, IPointerDownHandler, IPointerUpHandler
    {
        ...
        public void GoToPanel(int panelNumber)
        {
            ...
            TimeSetting._minuteNum = panelNumber;
        ...
        [Serializable] public class TransitionEffect
        {
            ...
            [SerializeField] private SimpleScrollSnap1 simpleScrollSnap1;
            #endregion
            ...
            #region Methods
            public TransitionEffect(string label, float minValue, float maxValue, float minDisplacement, float maxDisplacement, AnimationCurve function, SimpleScrollSnap1 simpleScrollSnap)
            {
                this.label = label;
                this.simpleScrollSnap1 = simpleScrollSnap;
            ...
            public void Init()
            {
                ...
                if (showPanel)
                {
                    ...
                    {
                        simpleScrollSnap1.transitionEffects.Remove(this);
                    }
